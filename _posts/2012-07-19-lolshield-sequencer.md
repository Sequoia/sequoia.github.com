...
![Young man using the LSS in the browser with the Arduino shield updating in real time](/img/lss_hi.png)

![A small group of people messing with the LSS](/img/lss_group.png)
