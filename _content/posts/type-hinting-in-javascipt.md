...
![example of tooltips and type hinting in JavaScript using VisualStudio Code](file:///Users/sequoia/sequoia.github.com/_content/img/typehint-example-1a.gif)

On projects of any size, code hinting reduces typos, makes coding easier, and obviates the need to check a module's documentation every few minutes. Programmers who use strongly typed languages like Java and IDEs like Eclipse take this sort of automated code-assistance for granted. But what about programmers who use Javascript JavaScript?
...
![demo of type hinting for String, Math, Console, and Document](file:///Users/sequoia/sequoia.github.com/_content/img/typehint-built-in-stuff.gif)
...
![demo of looking up core node.js api properties &amp; methods using external node.js typescript definition file](file:///Users/sequoia/sequoia.github.com/_content/img/typehint-node-core-apis.gif)
...
![example demonstrating property and method lookup of a application dependency (lodash)](file:///Users/sequoia/sequoia.github.com/_content/img/typehint-lodash.gif)
...
![example of hinting function parameters &amp; types based on JSDoc comments](file:///Users/sequoia/sequoia.github.com/_content/img/typehint-jsdoc.gif)
...
![example demonstrating looking up properties on an object based on a local Typescript Definition](file:///Users/sequoia/sequoia.github.com/_content/img/typehint-mapconfig.gif)

I have been very much enjoying the benefits of JSDoc, Typescript Declarations and the `typings` repository in my work. Hopefully this article will help you get started up and running with type hinting in JavaScript!