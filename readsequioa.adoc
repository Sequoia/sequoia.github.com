...
I only use pages for things that are not time-bound, i.e. information that is unlikely to change in the next year.

It's my opinion that slide decks are for supporting live presentations, not for reading like a book.
...
WARNING: Don't try to do this on CircleCI
